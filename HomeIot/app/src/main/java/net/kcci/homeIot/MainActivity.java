...
import net.kcci.homeIot.ClientThread;
import net.kcci.homeIot.Fragment1Home;
import net.kcci.homeIot.Fragment2;
import net.kcci.homeIot.Fragment3Telnet;
import net.kcci.homeIot.LoginActivity;
